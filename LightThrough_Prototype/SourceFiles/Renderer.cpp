...
// サンプラーステート切り替え
//#define _USE_ANISOTROPIC_FILTERING
#ifdef _USE_ANISOTROPIC_FILTERING
	// サンプラーステート設定
...
#endif	//_USE_ANISOTROPIC_FILTERING

#ifndef _USE_ANISOTROPIC_FILTERING
	// サンプラーステート設定	UVが1を超えたら繰り返し描画されるようになる
	D3D11_SAMPLER_DESC samplerDesc{};
	//samplerDesc.Filter = D3D11_FILTER_ANISOTROPIC;
	samplerDesc.Filter = D3D11_FILTER_MIN_MAG_MIP_LINEAR;	// バイリニアフィルタリング
	samplerDesc.AddressU = D3D11_TEXTURE_ADDRESS_WRAP;	// U方向のWARP
	samplerDesc.AddressV = D3D11_TEXTURE_ADDRESS_WRAP;	// V方向のWARP
	samplerDesc.AddressW = D3D11_TEXTURE_ADDRESS_WRAP;	// W方向のWARP
	samplerDesc.MipLODBias = 0.0f;
	samplerDesc.MaxAnisotropy = 1;
	samplerDesc.ComparisonFunc = D3D11_COMPARISON_ALWAYS;	// なにこれ
	samplerDesc.BorderColor[0] = 0;			// いっぱい追加してみた
...
//サンプラーをセット
//-----------------------------------------------------------------
void Renderer::SetWrapSamplerState(void)
{
	m_DeviceContext->PSSetSamplers(0, 1, &m_SamplerState);
}
