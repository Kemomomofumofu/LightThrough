...
ECS_REFLECT_FIELD_INSPECT_ONLY(linearVelocity),
ECS_REFLECT_FIELD_INSPECT_ONLY(angularVelocity),
ECS_REFLECT_FIELD_INSPECT_ONLY(force),
ECS_REFLECT_FIELD_INSPECT_ONLY(torque),
