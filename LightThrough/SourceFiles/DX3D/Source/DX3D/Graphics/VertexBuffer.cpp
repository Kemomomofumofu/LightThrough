 ...
 */
dx3d::VertexBuffer::VertexBuffer(const VertexBufferDesc& _desc, const GraphicsResourceDesc& _gDesc)
	...
	vertex_list_size_(_desc.vertexListSize)
{
	...
	DX3DGraphicsLogThrowOnFail(device_.CreateBuffer(&buffDesc, &initData, &buffer_), "CreateBuffer を 失敗しました");
}
